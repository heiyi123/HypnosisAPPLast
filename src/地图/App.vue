    ...
    <div class="map-layout">
      <div class="map-canvas">
        ...
        <button
          ...
          class="map-marker"
          :class="[
            `map-marker--${loc.category}`,
            { 'map-marker--active': loc.id === selectedId },
          ]"
          :style="{
            left: `${loc.x}%`,
            top: `${loc.y}%`,
      ...
      <aside class="map-panel" aria-label="地点详情">
        ...
        <p class="map-panel-footnote">
          这是一个示意图，用来帮助玩家在脑中建立「斋明学园」的空间感，不是精确地图。
        </p>
      </aside>
    </div>
  </div>
...
const locations: MapLocation[] = [
  ...
  },
  {
    ...
    highlights: [
      '宿舍区与教学楼之间有规定的通学路线，早晚都会出现固定的“人流时间”。',
    ],
  },
  {
    id: 'dorm-boys',
    ...
    highlights: [
      '从这里前往教学楼的途中，能明显感受到自己被淹没在女生人海之中的视线差异。',
    ],
  },
  {
    id: 'gate',
...
.map-canvas {
  ...
  box-shadow: 0 0 0 1px rgba(15, 23, 42, 0.9), 0 18px 50px rgba(15, 23, 42, 0.65);
}
...
.map-marker {
  ...
  font-size: 11px;
  cursor: pointer;
  box-shadow: 0 0 0 1px rgba(30, 64, 175, 0.0);
  transition:
...
.map-marker-dot {
  ...
  height: 8px;
  border-radius: 999px;
  box-shadow: 0 0 10px rgba(251, 113, 133, 0.0);
}
